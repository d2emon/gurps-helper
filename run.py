...
class Attack:
    ...
    def p1(self):
        ...
        print("3. Apply all personal modifiers - for attacking on the move (B117), with your off hand (B13) or while using an unfamiliar weapon (B43); attacking with an All Out Attack or a Wild Swing (B105); attacking using a weapon in close combat (B111); and for your position (B203), shock from wounds (B126), etc ({}) - and go to [4]".format(self.skill))
